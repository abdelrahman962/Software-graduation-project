...
class StaffInvoiceDetailsScreen extends StatefulWidget {
  ...
  const StaffInvoiceDetailsScreen({super.key, required this.orderId});

  @override
  State<StaffInvoiceDetailsScreen> createState() =>
      _StaffInvoiceDetailsScreenState();
}
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          ...
          _orderInfo =
              response; // Use the full response since patient info is at root level
